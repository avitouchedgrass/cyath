      ...
      <main className="relative z-10 flex-1 flex flex-col justify-center px-6 lg:px-12 pt-28 sm:pt-32 lg:pt-36 pb-20">
        ...
        <section id="methodology" className="w-full max-w-7xl mx-auto mt-28 sm:mt-36 pt-16 border-t border-white/10">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="font-serif text-3xl sm:text-4xl font-normal tracking-[-0.02em] text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="backdrop-blur-xl bg-white/[0.02] border border-white/10 rounded-2xl p-6 hover:bg-white/[0.04] transition-all">
              ...
              <h3 className="text-lg font-serif font-normal text-white mb-2 tracking-tight">Monochrome Streak Heatmaps</h3>
            ...
            <div className="backdrop-blur-xl bg-white/[0.02] border border-white/10 rounded-2xl p-6 hover:bg-white/[0.04] transition-all">
              ...
              <h3 className="text-lg font-serif font-normal text-white mb-2 tracking-tight">Subjective Energy Correlation</h3>
              <p className="text-xs sm:text-sm text-neutral-400 leading-relaxed font-sans">
            ...
            <div className="backdrop-blur-xl bg-white/[0.02] border border-white/10 rounded-2xl p-6 hover:bg-white/[0.04] transition-all">
              ...
              <h3 className="text-lg font-serif font-normal text-white mb-2 tracking-tight">Pixel-Calibrated Fuel</h3>
              <p className="text-xs sm:text-sm text-neutral-400 leading-relaxed font-sans">
