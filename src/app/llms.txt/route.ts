...
1. **Whole-Food Protein Calibration**: Hitting 120g+ daily protein targets with curated chef recipes.
2. **Frictionless 30-Second Check-Ins**: Logging water (2.5L+), sleep restoration (7.5h+), and 1-10 energy ratings.
...
- /recipes: Catalog of high-protein, steady-carb, and keto-clean whole-food dishes with dynamic portion multipliers (0.5x, 1.0x, 1.5x, 2.0x), ingredient lists, cooking instructions, and computer-vision meal scanner.
