    ...
    <div className="min-h-screen bg-[#F4F0EA] text-[#1A3629] flex flex-col items-center justify-center px-4 sm:px-6 py-10 relative overflow-hidden selection:bg-[#1A3629] selection:text-[#FFFDF9]">
      <div className="relative z-10 w-full max-w-2xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <Link
            href="/"
            className="inline-flex items-center gap-1.5 text-xs font-mono font-bold px-3 py-1.5 rounded-full border-2 bg-[#1A3629] border-[#1A3629] text-[#FFFDF9] shadow-[2px_2px_0px_#3A6B52] hover:-translate-y-0.5 active:translate-x-[1px] active:translate-y-[1px] active:shadow-none transition-all cursor-pointer"
          >
            <span>← Home</span>
          </Link>
        ...
        {/* Main Card Container */}
        <div className="rounded-3xl p-6 sm:p-9 border-2 border-[#1A3629] bg-[#FAF8F5] shadow-[8px_8px_0px_#1A3629] transition-all">
          {/* ========================================================================= */}
          {/* STEP 1: Baseline Demographics & Biometrics                                */}
          {/* ========================================================================= */}
          {step === 1 && (
            <div className="space-y-6">
              <div>
                ...
                <h1 className="font-fraunces font-bold text-2xl sm:text-3xl tracking-tight text-[#1A3629] mt-1">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="e.g. 28"
                      className={`w-full px-4 py-3 rounded-xl border-2 text-sm font-mono font-bold focus:outline-none bg-[#F4F0EA] ${!isAgeValid && age !== ''
                ...
                <div className="pt-2">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex items-center gap-1 p-0.5 rounded-lg border border-[#1A3629]/30 bg-[#F4F0EA] text-[11px] font-mono font-bold">
                      <button
                        type="button"
                        onClick={() => setIsImperial(false)}
                        className={`px-2 py-0.5 rounded cursor-pointer ${!isImperial ? 'bg-[#1A3629] text-[#FFFDF9]' : 'opacity-60 text-[#1A3629]'
                          }`}
                      >
                        Metric
                      </button>
                  ...
                  <div className="mt-4 p-4 rounded-xl border border-[#1A3629]/20 bg-[#F4EFE6] flex items-center justify-between">
                    <div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                    <button
                      ...
                      className={`p-3 rounded-xl border-2 text-left cursor-pointer transition-all ${auditAnswers.caffeineTiming === 'immediate'
                    ...
                    <button
                      ...
                      className={`p-3 rounded-xl border-2 text-left cursor-pointer transition-all ${auditAnswers.caffeineTiming === 'delayed'
                          ? 'bg-[#1A3629] text-[#FFFDF9] border-[#1A3629] shadow-[3px_3px_0px_#C9A84C]'
                          : 'bg-[#FFFDF9] text-[#1A3629] border-[#1A3629]/30 hover:border-[#1A3629]'
                        }`}
                    >
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                    <button
                      ...
                      className={`p-3 rounded-xl border-2 text-left cursor-pointer transition-all ${auditAnswers.middayFuel === 'high_carb'
                          ? 'bg-[#1A3629] text-[#FFFDF9] border-[#1A3629] shadow-[3px_3px_0px_#C9A84C]'
                          : 'bg-[#FFFDF9] text-[#1A3629] border-[#1A3629]/30 hover:border-[#1A3629]'
                        }`}
                    >
                    ...
                    <button
                      ...
                      className={`p-3 rounded-xl border-2 text-left cursor-pointer transition-all ${auditAnswers.middayFuel === 'high_protein'
                          ? 'bg-[#1A3629] text-[#FFFDF9] border-[#1A3629] shadow-[3px_3px_0px_#C9A84C]'
                          : 'bg-[#FFFDF9] text-[#1A3629] border-[#1A3629]/30 hover:border-[#1A3629]'
                        }`}
                    >
                    ...
                    <button
                      ...
                      className={`p-3 rounded-xl border-2 text-left cursor-pointer transition-all ${auditAnswers.middayFuel === 'skip_fast'
                          ? 'bg-[#1A3629] text-[#FFFDF9] border-[#1A3629] shadow-[3px_3px_0px_#C9A84C]'
                          : 'bg-[#FFFDF9] text-[#1A3629] border-[#1A3629]/30 hover:border-[#1A3629]'
                        }`}
                    >
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                    <button
                      ...
                      className={`p-3 rounded-xl border-2 text-left cursor-pointer transition-all ${auditAnswers.afternoonSlump === 'severe'
                          ? 'bg-[#1A3629] text-[#FFFDF9] border-[#1A3629] shadow-[3px_3px_0px_#C9A84C]'
                          : 'bg-[#FFFDF9] text-[#1A3629] border-[#1A3629]/30 hover:border-[#1A3629]'
                        }`}
                    >
                    ...
                    <button
                      ...
                      className={`p-3 rounded-xl border-2 text-left cursor-pointer transition-all ${auditAnswers.afternoonSlump === 'moderate'
                          ? 'bg-[#1A3629] text-[#FFFDF9] border-[#1A3629] shadow-[3px_3px_0px_#C9A84C]'
                          : 'bg-[#FFFDF9] text-[#1A3629] border-[#1A3629]/30 hover:border-[#1A3629]'
                        }`}
                    >
                    ...
                    <button
                      ...
                      className={`p-3 rounded-xl border-2 text-left cursor-pointer transition-all ${auditAnswers.afternoonSlump === 'none'
                          ? 'bg-[#1A3629] text-[#FFFDF9] border-[#1A3629] shadow-[3px_3px_0px_#C9A84C]'
                          : 'bg-[#FFFDF9] text-[#1A3629] border-[#1A3629]/30 hover:border-[#1A3629]'
                        }`}
                    >
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                    <button
                      ...
                      className={`p-3 rounded-xl border-2 text-left cursor-pointer transition-all ${auditAnswers.screenCutoff === 'within_30m'
                          ? 'bg-[#1A3629] text-[#FFFDF9] border-[#1A3629] shadow-[3px_3px_0px_#C9A84C]'
                          : 'bg-[#FFFDF9] text-[#1A3629] border-[#1A3629]/30 hover:border-[#1A3629]'
                        }`}
                    >
                    ...
                    <button
                      ...
                      className={`p-3 rounded-xl border-2 text-left cursor-pointer transition-all ${auditAnswers.screenCutoff === 'filtered'
                          ? 'bg-[#1A3629] text-[#FFFDF9] border-[#1A3629] shadow-[3px_3px_0px_#C9A84C]'
                          : 'bg-[#FFFDF9] text-[#1A3629] border-[#1A3629]/30 hover:border-[#1A3629]'
                        }`}
                    >
                    ...
                    <button
                      ...
                      className={`p-3 rounded-xl border-2 text-left cursor-pointer transition-all ${auditAnswers.screenCutoff === 'dark_60m'
                          ? 'bg-[#1A3629] text-[#FFFDF9] border-[#1A3629] shadow-[3px_3px_0px_#C9A84C]'
                          : 'bg-[#FFFDF9] text-[#1A3629] border-[#1A3629]/30 hover:border-[#1A3629]'
                        }`}
                    >
          ...
          {step === 3 && (
            <div className="space-y-6">
              ...
              <div className="p-5 rounded-2xl border border-[#1A3629]/20 bg-[#F4EFE6] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                  ...
                  <div className="font-fraunces font-black text-3xl sm:text-4xl text-[#1A3629] mt-1">
                ...
                <div className="p-3.5 rounded-xl border border-[#1A3629]/15 bg-[#FFFDF9] text-right font-mono shrink-0">
          ...
          {step === 4 && (
            <div className="space-y-6">
              ...
              <div className="space-y-3.5">
                ...
                <div className="p-4 rounded-2xl border border-[#1A3629]/20 bg-[#F4EFE6]">
                  ...
                  <div className="font-fraunces font-bold text-lg text-[#1A3629] mt-1">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="p-3.5 rounded-xl border border-[#1A3629]/20 bg-[#FFFDF9]">
                ...
                {/* 3. Setup XP Bonus */}
                <div className="p-3.5 rounded-xl border border-[#1A3629]/20 bg-[#FFFDF9] flex items-center justify-between shadow-[2px_2px_0px_#C9A84C]">
                  ...
                  <span className="font-mono text-xs font-black px-2.5 py-1 rounded bg-[#1A3629] text-[#FFFDF9]">
                    +100 XP
                  </span>
                </div>
              </div>
          ...
          {/* Navigation Controls */}
          <div className="flex items-center justify-between pt-6 mt-6 border-t-2 border-[#1A3629]/15">
            {step > 1 ? (
              <button
                type="button"
                onClick={prevStep}
                className="px-4 py-2.5 rounded-xl border-2 border-[#1A3629] bg-[#FFFDF9] text-[#1A3629] font-mono text-xs font-bold hover:bg-[#F4F0EA] transition-all cursor-pointer"
              >
                ← Back
              </button>
            ) : (
            ...
            <button
              ...
              className={`px-6 py-3 rounded-xl border-2 border-[#1A3629] font-mono text-xs font-bold transition-all flex items-center gap-2 cursor-pointer ${step === 1 && !isAgeValid
                  ? 'bg-gray-300 border-gray-400 text-gray-500 cursor-not-allowed'
                  : 'bg-[#1A3629] text-[#FFFDF9] shadow-[3px_3px_0px_#3A6B52] hover:shadow-[4px_4px_0px_#3A6B52] hover:-translate-y-0.5 active:translate-x-[1px] active:translate-y-[1px] active:shadow-none'
                }`}
            >
              <span>
                {step === totalSteps
